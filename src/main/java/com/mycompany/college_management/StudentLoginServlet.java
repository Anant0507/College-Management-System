...
import java.sql.*;
import BussinessLogic.StudentCredential;
import javax.servlet.http.HttpSession;

public class StudentLoginServlet extends HttpServlet {
    private Connection con;
    private String DbName,DbPass;
    private StudentCredential sc;
    @Override
    public void init()
    {
        try {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(sc.checkStuCredential(eno,pword,con))
        {
            s.setAttribute("Enrollment",eno);
            System.out.println((String)s.getAttribute("Enrollment"));
            response.sendRedirect("WelcomeStu.jsp");
        }
        else
        {
            s.setAttribute("WrongCredential","Invalid Credential!");
            System.out.println((String)s.getAttribute("WrongCredential"));
